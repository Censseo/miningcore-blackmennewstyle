...
sudo apt-get update; \
  sudo apt-get -y install dotnet-sdk-8.0 git cmake ninja-build build-essential libssl-dev pkg-config libboost-all-dev libsodium-dev libzmq5-dev libgmp-dev
